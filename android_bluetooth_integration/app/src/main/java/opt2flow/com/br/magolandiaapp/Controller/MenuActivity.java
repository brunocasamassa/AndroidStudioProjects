...
public class MenuActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        */
        if (id == R.id.parearBluetoothAction) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    ControleManualTab tab1 = new ControleManualTab();
                    return tab1;
                case 1:
                    ExpressoesTab tab2 = new ExpressoesTab();
                    return tab2;
                /*
                case 2:
                    ControleMistoTab tab3 = new ControleMistoTab();
                    return tab3;
                case 3:
                    CenasTab tab4 = new CenasTab();
                    return tab4;
                */
                case 2:
                    ConfiguracoesTab tab5 = new ConfiguracoesTab();
                    return tab5;
                default:
                    return null;
            }
